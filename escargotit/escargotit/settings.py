"""
Django settings for escargotit project.
...
SECRET_KEY = 'django-insecure-2+1xwss*ohv58p-#06u3)6ro#kke(kk3zn94pli=4ipju(i5f&'
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny', # allow all for testing environment
    ]
}
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')], #where django should look for template files
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'escargotit.wsgi.application'
...
# make urls with and without ending slash work
APPEND_SLASH = True
